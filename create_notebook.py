#!/usr/bin/env python3
"""
Script to create a comprehensive Jupyter notebook for the Study Assistant project.
"""
...
def create_notebook():
    """Create the study assistant demo notebook"""
    ...
    with open('study_assistant_demo.ipynb', 'w', encoding='utf-8') as f:
        json.dump(notebook, f, indent=2, ensure_ascii=False)
    
    print("✅ Successfully created study_assistant_demo.ipynb")
    print("📖 The notebook contains comprehensive demonstrations of:")
    print("   • Basic setup and configuration")
    print("   • StudyAssistant class usage")
    print("   • Question testing with different styles")
    print("   • Memory and context testing")
    print("   • API server testing")
    print("   • Vector storage testing")
